...
var search_url = "https://api.themoviedb.org/3/search/movie?api_key=a706f5a1d524a2c7d54e77394dfbeee7&language=en-US&query="
...
$(function() {
  ...
  function api_search(e) {
    ...
    $("#search-url").attr("value", search_api_url);
    $.ajax({
      url: search_api_url,
      datatype: "json",
  ...
  function render(parsed_json) {
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if (i % 4 === 0) {
        $("movie-grid").append('div class="row"');
      }
